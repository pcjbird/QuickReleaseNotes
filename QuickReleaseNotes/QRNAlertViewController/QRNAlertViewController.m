...
@interface QRNHighLightButton : UIButton

@property (strong, nonatomic) UIColor *highlightedColor;

@end

@implementation QRNHighLightButton
...
@interface QRNAlertAction ()

@property (copy, nonatomic) void(^actionHandler)(QRNAlertAction *action);

@end

@implementation QRNAlertAction

+ (instancetype)actionWithTitle:(NSString *)title handler:(void (^)(QRNAlertAction *action))handler {
    QRNAlertAction *instance = [QRNAlertAction new];
...
@implementation QRNAlertViewController

+ (instancetype)alertControllerWithTitle:(NSString *)title message:(NSString *)message {
    
    QRNAlertViewController *instance = [QRNAlertViewController new];
...
- (void)creatAllButtons {
    ...
    for (int i=0; i<self.actions.count; i++) {
        ...
        QRNHighLightButton *btn = [QRNHighLightButton new];
        btn.tag = 10+i;
...
- (void)didClickButton:(UIButton *)sender {
    QRNAlertAction *action = self.actions[sender.tag-10];
...
- (NSArray<QRNAlertAction *> *)actions {
